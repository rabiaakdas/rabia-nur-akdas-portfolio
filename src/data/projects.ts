...
export const projects: Project[] = [
  ...
  {
    id: "voiceAnalysisDeepLearning",
    titleKey: "projects.items.voiceAnalysisDeepLearning.title",
    categoryKey: "projects.items.voiceAnalysisDeepLearning.category",
    shortDescriptionKey: "projects.items.voiceAnalysisDeepLearning.shortDescription",
    image: "/voice-analysis-cover.png",
    technologies: ["Python", "NumPy", "Librosa", "OpenCV", "Matplotlib", "Scikit-learn", "TensorFlow", "Keras", "CNN"],
    featuresKey: "projects.items.voiceAnalysisDeepLearning.features",
    learningOutcomeKey: "projects.items.voiceAnalysisDeepLearning.learningOutcome",
    architectureKey: "projects.items.voiceAnalysisDeepLearning.architecture",
    githubUrl: "https://github.com/rabiaakdas/Voice-Analysis-Project-Deep-Learning",
  },
  {
    id: "melanomaSkinCancer",
    titleKey: "projects.items.melanomaSkinCancer.title",
    categoryKey: "projects.items.melanomaSkinCancer.category",
    shortDescriptionKey: "projects.items.melanomaSkinCancer.shortDescription",
    image: "/melanoma-skin-cancer-cover.png",
    technologies: ["Python", "TensorFlow", "Keras", "NumPy", "Matplotlib", "Scikit-learn", "ImageDataGenerator", "CNN"],
    featuresKey: "projects.items.melanomaSkinCancer.features",
    learningOutcomeKey: "projects.items.melanomaSkinCancer.learningOutcome",
    architectureKey: "projects.items.melanomaSkinCancer.architecture",
    githubUrl: "https://github.com/rabiaakdas/Melanoma-Skin-Cancer",
  },
  {
    id: "usaAccidentDataAnalysis",
    titleKey: "projects.items.usaAccidentDataAnalysis.title",
    categoryKey: "projects.items.usaAccidentDataAnalysis.category",
    shortDescriptionKey: "projects.items.usaAccidentDataAnalysis.shortDescription",
    image: "/usa-acc-cover.png",
    technologies: ["Python", "Pandas", "NumPy", "Scikit-learn", "PCA", "SMOTE", "XGBoost", "LightGBM", "CatBoost", "Matplotlib", "Seaborn"],
    featuresKey: "projects.items.usaAccidentDataAnalysis.features",
    learningOutcomeKey: "projects.items.usaAccidentDataAnalysis.learningOutcome",
    architectureKey: "projects.items.usaAccidentDataAnalysis.architecture",
    githubUrl: "https://github.com/rabiaakdas/usa-acc",
  },
];
